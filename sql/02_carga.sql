...
-- ARQUIVO: 02_carga.sql — Script de Carga de Dados Realistas (DML)
-- ============================================================================
-- ATENDE AOS CRITÉRIOS DE VOLUME E REALISMO:
-- 1. Mais de 40 registros nas tabelas principais (tb_pessoa, tb_aluno, tb_contrato_plano).
-- 2. Mais de 100 registros na tabela de maior movimento (tb_pagamento).
-- 3. Casos de contorno propositais:
--    - Contatos opcionais nulos (telefone em branco).
--    - Pagamentos pendentes, atrasados e quitados.
--    - Alunos sem indicação e alunos indicados por colegas.
--    - Instrutor supervisor e instrutores supervisionados.
--    - Séries históricas com múltiplas avaliações físicas para o mesmo aluno.
-- ============================================================================
